...
public class AdminProfessorController implements Initializable {
	...
	@FXML
	private TableColumn<Professor, String> clmnEmail;
	@FXML
	private TableColumn<Professor, String> clmnNames;
	@FXML
	private TableColumn<Professor, String> clmnLastNames;
	@FXML
	private TableColumn<Professor, String> clmnPersonalNo;
	@FXML
	private TableColumn<Professor, String> clmnShift;
	@FXML
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		clmnNames.setCellValueFactory(new PropertyValueFactory<>("names"));
		clmnLastNames.setCellValueFactory(new PropertyValueFactory<>("lastnames"));
		clmnPersonalNo.setCellValueFactory(new PropertyValueFactory<>("personalNo"));
		clmnShift.setCellValueFactory(new PropertyValueFactory<>("shift"));
