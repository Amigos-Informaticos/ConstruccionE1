...
public class DAOCoordinator implements IDAOUser, IDAOCoordinator {
	...
	public boolean isRegistered() {
		String query = "SELECT COUNT(Usuario.idUsuario) AS TOTAL FROM Usuario INNER JOIN Coordinador " +
	...
	public boolean isAnother() {
		...
		String query = "SELECT COUNT (Coordinador.idUsuario) AS TOTAL FROM Coordinador INNER JOIN User ON Coordinador.idUsuario = Usuario.idUsuario WHERE Usuario.status = 1";
		String[] names = {"TOTAL"};
